...
![Laravel Version](https://img.shields.io/badge/laravel-%5E9.19-F13C30)
![PHPUnit Version](https://img.shields.io/badge/phpunit-%5E9.6-3A97D0)
...
```bash
git clone git@github.com:kiipod/1622797-what-to-watch-2.git wtw
```
